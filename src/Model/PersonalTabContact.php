...
/**
 * PersonalTabContact Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class PersonalTabContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'personal_tab_contact';
...
'client_key' => 'getClientKey'    ];
     ...
     * Sets event
     *
     * @param string $event 事件名为personal_tab_contact
     *
     * @return $this
     */
