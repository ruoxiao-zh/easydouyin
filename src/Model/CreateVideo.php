...
/**
 * CreateVideo Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class CreateVideo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'create_video';
...
'from_user_id' => 'string',
'client_key' => 'string',
'content' => '\Douyin\Open\Model\CreateVideoContent'    ];
...
'content' => 'getContent'    ];
     ...
     * Sets event
     *
     * @param string $event 事件名为create_video
     *
     * @return $this
     */
     ...
     * Sets from_user_id
     *
     * @param string $from_user_id 发起用户user_id
     *
     * @return $this
     */
     ...
     * Gets content
     *
     * @return \Douyin\Open\Model\CreateVideoContent
     */
     ...
     * Sets content
     *
     * @param \Douyin\Open\Model\CreateVideoContent $content content
     *
     * @return $this
     */
