...
/**
 * EnterpriseLeadsUserListResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class EnterpriseLeadsUserListResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnterpriseLeadsUserListResponseData';
...
'list' => 'string[]',
'users' => '\Douyin\Open\Model\EnterpriseLeadsUserListResponseDataUsers[]'    ];
...
'users' => 'getUsers'    ];
     ...
     * Sets list
     *
     * @param string[] $list 用户OPENID (见users)
     *
     * @return $this
     */
     ...
     * Gets users
     *
     * @return \Douyin\Open\Model\EnterpriseLeadsUserListResponseDataUsers[]
     */
     ...
     * Sets users
     *
     * @param \Douyin\Open\Model\EnterpriseLeadsUserListResponseDataUsers[] $users users
     *
     * @return $this
     */
