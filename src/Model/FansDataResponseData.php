...
/**
 * FansDataResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class FansDataResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FansDataResponseData';
...
'fans_data' => 'getFansData'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fans_data'] = isset($data['fans_data']) ? $data['fans_data'] : null;
    }
     ...
     * Gets fans_data
     *
     * @return \Douyin\Open\Model\FansData
     */
    public function getFansData()
    {
        return $this->container['fans_data'];
    }

    /**
     * Sets fans_data
     *
     * @param \Douyin\Open\Model\FansData $fans_data fans_data
     *
     * @return $this
     */
    public function setFansData($fans_data)
    {
        $this->container['fans_data'] = $fans_data;
