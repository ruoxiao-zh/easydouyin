...
/**
 * VideoCommentListResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class VideoCommentListResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoCommentListResponseData';
...
'list' => '\Douyin\Open\Model\VideoCommentListResponseDataList[]'    ];
...
'list' => 'getList'    ];
     ...
     * Gets list
     *
     * @return \Douyin\Open\Model\VideoCommentListResponseDataList[]
     */
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\VideoCommentListResponseDataList[] $list list
     *
     * @return $this
     */
