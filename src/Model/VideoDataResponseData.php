...
/**
 * VideoDataResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class VideoDataResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoDataResponseData';
...
'list' => 'getList'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['video_data'] = isset($data['video_data']) ? $data['video_data'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['video_data'] === null) {
            $invalidProperties[] = "'video_data' can't be null";
        }
     ...
     * Gets video_data
     *
     * @return \Douyin\Open\Model\VideoDataResponseDataResponse[]
     */
     ...
     * Sets video_data
     *
     * @param \Douyin\Open\Model\VideoDataResponseDataResponse[] $video_data 见list
     *
     * @return $this
     */
     ...
     * Gets list
     *
     * @return \Douyin\Open\Model\Video[]
     */
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\Video[] $list list
     *
     * @return $this
     */
