...
/**
 * ToutiaoVideoUploadResponseDataVideo Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class ToutiaoVideoUploadResponseDataVideo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ToutiaoVideoUploadResponseDataVideo';
