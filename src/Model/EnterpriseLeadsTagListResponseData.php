...
/**
 * EnterpriseLeadsTagListResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class EnterpriseLeadsTagListResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnterpriseLeadsTagListResponseData';
...
'list' => '\Douyin\Open\Model\EnterpriseLeadsUserListResponseDataResponse[]'    ];
...
'list' => 'getList'    ];
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\EnterpriseLeadsUserListResponseDataResponse[] $list list
     *
     * @return $this
     */
