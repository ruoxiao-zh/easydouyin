...
/**
 * HotsearchSentencesResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class HotsearchSentencesResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HotsearchSentencesResponseData';
...
'active_time' => 'string',
'list' => '\Douyin\Open\Model\HotSentence[]'    ];
...
'list' => 'getList'    ];
     ...
     * Gets list
     *
     * @return \Douyin\Open\Model\HotSentence[]
     */
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\HotSentence[] $list 实时热点词
     *
     * @return $this
     */
