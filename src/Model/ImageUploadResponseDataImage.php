...
/**
 * ImageUploadResponseDataImage Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class ImageUploadResponseDataImage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ImageUploadResponseDataImage';
