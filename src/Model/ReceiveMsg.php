...
/**
 * ReceiveMsg Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class ReceiveMsg implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'receive_msg';
...
'content' => 'getContent'    ];
     ...
     * Sets event
     *
     * @param string $event 事件名为receive_msg
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param object $content 具体见私信事件列表
     *
     * @return $this
     */
