...
/**
 * HotsearchVideosResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class HotsearchVideosResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HotsearchVideosResponseData';
...
'list' => 'getList'    ];
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\Video[] $list 视频列表
     *
     * @return $this
     */
