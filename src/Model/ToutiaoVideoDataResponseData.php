...
/**
 * ToutiaoVideoDataResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class ToutiaoVideoDataResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ToutiaoVideoDataResponseData';
...
'list' => 'getList'    ];
     ...
     * Gets list
     *
     * @return \Douyin\Open\Model\ToutiaoVideo[]
     */
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\ToutiaoVideo[] $list list
     *
     * @return $this
     */
