...
/**
 * PoiExtHotelOrderCommitResponse1 Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class PoiExtHotelOrderCommitResponse1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PoiExtHotelOrderCommitResponse_1';
...
'date_price' => 'getDatePrice'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_price'] === null) {
            $invalidProperties[] = "'date_price' can't be null";
        }
     ...
     * Sets date
     *
     * @param string $date 入住日期 yyyyMMdd
     *
     * @return $this
     */
     ...
     * Sets date_price
     *
     * @param int $date_price 入住日价格, 人民币分
     *
     * @return $this
     */
