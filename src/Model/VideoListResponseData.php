...
/**
 * VideoListResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class VideoListResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoListResponseData';
...
'list' => 'getList'    ];
     ...
     * Sets list
     *
     * @param \Douyin\Open\Model\Video[] $list 由于置顶的原因, list长度可能比count指定的数量多一些或少一些。
     *
     * @return $this
     */
