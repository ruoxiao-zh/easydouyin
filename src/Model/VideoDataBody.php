...
/**
 * VideoDataBody Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class VideoDataBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoDataBody';
     ...
     * Sets item_ids
     *
     * @param string[] $item_ids item_id数组，仅能查询access_token对应用户上传的视频
     *
     * @return $this
     */
