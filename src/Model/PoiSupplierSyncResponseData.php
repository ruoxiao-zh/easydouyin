...
/**
 * PoiSupplierSyncResponseData Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class PoiSupplierSyncResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PoiSupplierSyncResponseData';
...
'description' => 'getDescription'    ];
     ...
     * Sets supplier_id
     *
     * @param string $supplier_id 抖音平台商户ID
     *
     * @return $this
     */
