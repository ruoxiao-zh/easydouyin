...
/**
 * EnterpriseLeadsTagCreateBody Class Doc Comment
 *
 * @category Class
 * @package  Douyin\Open
 * @author   抖音小开
 */
class EnterpriseLeadsTagCreateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnterpriseLeadsTagCreateBody';
